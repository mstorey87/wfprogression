...
datestart <- "2021-12-06"#dat.fire.polygon$StartDate
dateend <- "2021-12-10"#"2023-12-08"
...
dat.stac <- fire_search_stac(fire_bbox = dat.bbox,start_date = datestart,end_date = "2021-12-17")
head(dat.stac)
...
Get the associated line scans
Each polygon have more than one scan in the s3name field, seperate by ;
```{r}
list.scans <- dat.progs.sf$s3name %>% 
  stringr::str_split(.,";")
